...
with sync_playwright() as p:
    ...
    try:
        ...
        submit_btn = page.locator("button[type='submit'], button:has-text('Login'), button:has-text('Iniciar')")
    ...
    try:
        ...
        submit_btn = page.locator("button[type='submit'], button:has-text('Login'), button:has-text('Iniciar')").first
    ...
    try:
        page.goto("http://localhost:5173", timeout=10000)
        page.wait_for_load_state("networkidle", timeout=10000)
        nav_links = page.locator("nav a, header a, [class*='nav'] a, [class*='Nav'] a")
